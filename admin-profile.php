...
$admin_id = $_SESSION['userid']; // admin session id
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt2->bind_param("sssssssi", $profile, $name, $email, $phone, $address, $cv, $coverletter, $admin_id);
...
<section id="adminProfile" class="py-5" style="background-color: #f0f8ff1a;">
  <div class="container">
      ...
      <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 text-center">
          ...
          <?php if ($admin['profile']) { ?>
            <img src="<?= $admin['profile'] ?>" width="120" class="mb-2 rounded-circle">
          <?php } ?>
        ...
        <div class="mb-3">
          ...
          <textarea name="address" class="form-control" rows="2"><?= $admin['address'] ?></textarea>
        </div>
        ...
        <div class="mb-3">
          ...
          <?php if ($admin['cv']) { ?>
            <a href="<?= $admin['cv'] ?>" target="_blank">View Current CV</a><br>
          <?php } ?>
        ...
        <div class="mb-3">
          ...
          <?php if ($admin['coverletter']) { ?>
            <a href="<?= $admin['coverletter'] ?>" target="_blank">View Current Cover Letter</a><br>
          <?php } ?>
